...
class FusedMoE(torch.nn.Module):
    ...
    def __init__(
        ...
        try:
            ...
            print(f"get_tensor_model_parallel_world_size() failed, use 1 as tp_size")
            self.tp_size = 1
        # # TODO: use real tp size
        # # self.tp_size = (
        # #     tp_size if tp_size is not None else get_tensor_model_parallel_world_size()
        # # )
        # self.tp_size = 1
    ...
    def weight_loader(
        ...
        try:
            ...
            # print(f"get_tensor_model_parallel_rank() failed, use 0 as tp_rank")
            tp_rank = 0
