...
class LogitsProcessorOutput:
    ## Part 1: This part will be assigned in python/janus/srt/layers/logits_processor.py::LogitsProcessor
    ...
    ## Part 2: This part will be assigned in python/janus/srt/layers/sampler.py::Sampler
    ...
    ## Part 3: Prefill-only. This part will be assigned in python/janus/srt/layers/logits_processor.py::LogitsProcessor
