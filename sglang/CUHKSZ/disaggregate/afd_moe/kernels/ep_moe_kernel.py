...
class GroupedGemmRunner(torch.nn.Module):
    ...
    def forward(
        ...
        if self.use_flashinfer:
            # TODO: flashinfer
            raise "flashinfer backend not supported"
...
class EPMoE(torch.nn.Module):
    ...
    def __init__(
        ...
        self.num_experts_per_partition = self.end_expert_id - self.start_expert_id + 1
        self.top_k = top_k
    ...
    def forward(self, cat_hidden_states: torch.Tensor, topk_ids: torch.Tensor, topk_weights: torch.Tensor):
        ...
        try:
            ...
            print(f"Error in grouped_gemm_runner1: {e}")
            raise e
        ...
        try:
            ...
            print(f"Error in grouped_gemm_runner2: {e}")
            raise e
