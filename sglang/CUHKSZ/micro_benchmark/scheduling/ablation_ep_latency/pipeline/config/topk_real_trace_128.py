...
topk_id = torch.tensor([[ 23, 123, 145, 129, 135, 138],
        ...
        [ 21,  26,  34,  96, 159,  20],
        [ 11,  32,  33,  35,  67,  19],
        [ 28,  37,  44, 148, 149, 150],
        [  9,  40, 105, 113,   3,   6],
        [ 88, 109, 118,  16,  87, 117],
        [ 32,  70,  78,  83,  89,  35],
        [  1,   4,  69, 145,   2,  10],
        [ 28,  78, 128,  33,  77, 134],
        [  3,   5,  76,  79, 102, 109],
        ...
        [ 43,  47,  83, 159,  85, 146],
        [ 25,  34,  69,  77, 145,  79],
        [115,  89, 105, 117, 143, 154],
        [  5,  13,  28,  80,  84,  94],
        [ 40,  48,  89,  93, 128,  90],
        [ 43,  46,  52,  63, 126,  60],
        [ 23, 128, 136, 142, 159, 120],
        [ 24,  34,  55, 146, 157,  39],
        [  3,  19,  92, 113, 115, 105],
        [  1,   2,  26,  29,  31,  49],
        [ 19,  23, 105,   4,  16,  37],
        [ 62,  64,  88, 140,  61,  74],
        [ 39,  43, 106, 108, 115, 101],
        [ 20,  31,  88,  26,  29,  62],
        [ 15,  18, 124, 146, 156, 139],
        [ 37,  67,  79, 139,  75, 130],
        [ 31,  84,  88,  24,  29,  61],
        [ 92, 112, 127, 131, 121, 125],
        [ 30,  67,  75, 115,  61, 106],
        [ 17,  49,  50,  51, 158,  53],
        [  2,  10,  12,  88,  93,   1],
        [ 67,  85, 143, 153,  60, 157],
        [ 31,  62,  64,  84,  88,  20],
        [ 45,  54,  91, 120, 121,  93],
        [ 11,  48,  59, 128,  17,  19],
        [ 91,  92, 122, 141, 146,  82],
        [  3,  19,  40,  47, 102, 115],
        [  1,  31, 125, 127, 129, 130],
        [ 65,  73, 101, 103, 157, 145],
        [ 39,  79,  84,  87,  94,  95],
        [ 16,  26,  33,  39,  91,  20],
        [ 34,  36, 117, 118, 124, 110],
        [ 32,  38,  70,  73,  97,  79],
        [ 20,  62,  64,  88,  26,  29],
        [ 12,  79, 100, 117,  74, 108],
        [ 30,  34,  76,  79, 118,  33],
        [ 91,  96, 131, 134, 153, 125],
        [  5,  82,  87,  95, 113,   6],
        [ 18,  55,  57,  67,  68,   6]], device='cuda', dtype=torch.int32)

# layer59
topk_id1 = torch.tensor([[  2,   5,  14,  41,  91,  58],
        [ 32,  40,  45,  53, 149,  33],
